...
let street_dealer_locations = new Array(3);
let street_dealer_premium = new Array(3);
let street_dealer_coke = new Array(3);
let street_dealer_meth = new Array(3);
let street_dealer_weed = new Array(3);
let street_dealer_acid = new Array(3);
let rng = null;
